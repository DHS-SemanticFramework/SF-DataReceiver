...
public class DataTranslator {
	...
	public static JSONArray translateEvents(String results) {
		...
		/*
		 * Acceptable data schema for events: [ { "eventId": "22703251", "depth":
		 * "19.7", "latitude": "38.1076", "magnitude": "5.2", "timestamp":
		 * "2019-07-19T11:13:17.666000", "longitude": "23.5393" } ]
		 */
	...
	public static JSONArray translateFirecallEvents(String results) {

		/*
		 * Acceptable data schema for events: [ { "latitude": "38.1076",
		 * "additionalField": "value", "timestamp": "2019-07-19T11:13:17.666000",
		 * "longitude": "23.5393" } ]
		 */

		JsonArray entry = new Gson().fromJson(results, JsonArray.class);
		...
		for (int i = 0; i < entry.size(); i++) {
			...
			translatedEvent = new JSONObject();
			translatedEvent.put("incidentType", entry.get(i).getAsJsonObject().get("type").getAsString());
			translatedEvent.put("eventId", entry.get(i).getAsJsonObject().get("incident_number").getAsString());
			translatedEvent.put("timestamp", entry.get(i).getAsJsonObject().get("datetime").getAsString());
			translatedEvent.put("latitude", entry.get(i).getAsJsonObject().get("latitude").getAsString());
			translatedEvent.put("longitude", entry.get(i).getAsJsonObject().get("longitude").getAsString());
	...
	public static JSONArray translateCopernicusMetadata(String results, String source, String address) {
		...
		/*
		 * Acceptable data schema for copernicus metadata: [ { "date":
		 * "2019-07-30T15:29:18.175Z", "location":
		 * "MULTIPOLYGON (((38.069313 21.988863, 40.469334 22.408005, 40.154675 24.031868, 37.724159 23.615938, 38.069313 21.988863)))"
		 * , "id": "f828a4fb-a93b-4cee-9185-e8dad26aa6eb", "productURL":
		 * "https://scihub.copernicus.eu/dhus/odata/v1/Products('f828a4fb-a93b-4cee-9185-e8dad26aa6eb')/"
		 * } ]
		 */
